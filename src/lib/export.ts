...
<head>
  ...
  <style>
    body { font-family: Georgia, serif; max-width: 720px; margin: 40px auto; padding: 0 20px; color: #2D2D2B; background: #F9F9F7; line-height: 1.7; }
    ...
    code { background: #EFEAE3; padding: 0 4px; font-family: monospace; color: #CC7D5E; }
    a { color: #CC7D5E; }
    li { margin: 4px 0; }
  </style>
</head>
