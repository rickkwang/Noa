  ...
  return (
    <SettingSection title="App Update" description="Desktop app version and update channel status.">
      ...
      <SettingItem label="Current Version" description="Version reported by the desktop runtime.">
        <div className="bg-[#EAE8E0] border-[1.75px] border-[#2D2D2D] px-3 py-1.5 text-sm font-redaction">
          {version}
        </div>
      </SettingItem>

      <div className="py-4 border-b-[1.75px] border-[#2D2D2D]/20 last:border-0 space-y-3">
        <div>
        ...
        <div className="flex gap-2 flex-wrap">
          <button
            ...
            className="flex items-center justify-center gap-2 bg-[#EAE8E0] text-[#2D2D2D] px-4 py-2 font-bold border-[1.75px] border-[#2D2D2D] transition-colors text-sm disabled:opacity-60 disabled:pointer-events-none active:opacity-70"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-[#CC7D5E] text-white px-4 py-2 font-bold border-[1.75px] border-[#2D2D2D] transition-colors text-sm disabled:opacity-60 disabled:pointer-events-none active:opacity-70"
          >
            <InstallIcon size={14} />
