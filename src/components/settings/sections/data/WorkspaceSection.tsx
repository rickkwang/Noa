    ...
    <SettingSection title="Workspace" description="Manage your current working directory.">
      ...
      <div className="flex space-x-4 mt-4">
        <button
          ...
          className="flex-1 flex items-center justify-center space-x-2 bg-[#F9F9F7] text-[#2D2D2B] px-4 py-2 font-bold border border-[#2D2D2B] transition-colors text-sm"
        >
          <FolderOpen size={14} />
            ...
            {fsHandle ? (
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center justify-center space-x-2 bg-[#F9F9F7] text-[#2D2D2B] px-4 py-2 font-bold border border-[#2D2D2B] transition-colors text-sm disabled:opacity-60 disabled:pointer-events-none"
                >
                  <Unlink size={14} />
