    ...
    <SettingSection title="Backup" description="Export your data for safekeeping.">
      ...
      <SettingItem label="Export JSON Backup" description="Complete backup including metadata and settings.">
        <button
          ...
          className="flex items-center justify-center space-x-2 bg-[#CC7D5E] text-white px-4 py-2 font-bold border border-[#2D2D2B] transition-colors text-sm hover:opacity-90"
        >
          <Download size={14} />
      ...
      <SettingItem label="Export Vault" description="Export a local vault-style ZIP with markdown notes, attachments, and a manifest.">
        <button
          ...
          className="flex items-center justify-center space-x-2 bg-[#F9F9F7] text-[#2D2D2B] px-4 py-2 font-bold border border-[#2D2D2B] transition-colors text-sm hover:bg-[#EFEAE3] disabled:opacity-60 disabled:pointer-events-none"
        >
