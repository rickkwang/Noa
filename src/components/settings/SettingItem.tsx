...
export default function SettingItem({ label, description, children, stacked = false }: SettingItemProps) {
  if (stacked) {
    return (
      <div className="py-4 border-b border-[var(--divider-subtle)] last:border-0">
  ...
  return (
    <div className="flex flex-col gap-3 py-4 border-b border-[var(--divider-subtle)] last:border-0 md:flex-row md:items-center md:justify-between">
