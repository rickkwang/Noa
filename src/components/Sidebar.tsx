    ...
    >
      ...
      <div className="noa-sidebar-toolbar-mask h-8 flex items-center pt-1.5 pl-[9px] pr-2 gap-0.5 shrink-0 z-10 overflow-visible">
        <button
          ...
          className="p-1 text-[#2D2D2B]/80 hover:text-[#CC7D5E] transition-colors active:opacity-70"
          title="New note"
          aria-label="New note"
        >
          <SquarePen size={14} />
        ...
        <button
          ...
          className="flex items-center gap-1 px-1 py-1 transition-colors ml-auto text-[#2D2D2B]/80 hover:text-[#CC7D5E]"
